...
export function GoBack(props) {
  return (
    <span className="cursor-pointer  " {...props}>
      <svg
        className="w-6 h-12 fill-extra-light-grey"
        viewBox="0 0 24 24"
        aria-hidden="true"
      >
        <g>
...
export function InboxIcon({ classes, ...props }) {
  return (
    <span className="cursor-pointer  " {...props}>
...
export function HomeIcon({ classes, ...props }) {
  return (
    <span className="cursor-pointer  " {...props}>
      <svg viewBox="0 0 24 24" aria-hidden="true" className={classes}>
        <g>
...
export function NotificationsIcon({ classes, props }) {
  return (
    <span className="cursor-pointer  " {...props}>
      <svg viewBox="0 0 24 24" aria-hidden="true" className={classes}>
        <g>
...
export function ProfileIcon({ classes, ...props }) {
  return (
    <span className="cursor-pointer  " {...props}>
      <svg viewBox="0 0 24 24" aria-hidden="true" className={classes}>
        <g>
...
export function HashTagIcon({ classes, ...props }) {
  return (
    <span className="cursor-pointer  " {...props}>
      <svg viewBox="0 0 24 24" aria-hidden="true" className={classes}>
        <g>
...
export function ExploreIcon({ classes, ...props }) {
  return (
    <span className="cursor-pointer  " {...props}>
      <svg viewBox="0 0 24 24" aria-hidden="true" className={classes}>
        <g>
